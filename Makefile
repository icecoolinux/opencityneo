...
ACLOCAL = ${SHELL} /media/datos/Proyectos/OpenCity/codigo/opencityneo/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /media/datos/Proyectos/OpenCity/codigo/opencityneo/missing automake-1.14
AWK = gawk
BINRELOC_CFLAGS = 
BINRELOC_LIBS = 
CC = gcc
...
LIBOBJS = 
LIBS = -lSDL_net -lSDL_image -lGLU -lGL -L/usr/lib64 -lSDL -lSDL_mixer -lpng16 
